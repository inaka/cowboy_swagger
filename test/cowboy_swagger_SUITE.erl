...
-spec schema_test(Config :: cowboy_swagger_test_utils:config()) -> {comment, string()}.
schema_test(_Config) ->
    set_swagger_version(swagger_2_0),
...
parameters_ref_test(_Config) ->
    set_swagger_version(openapi_3_0_0),
    cowboy_swagger:add_definition(#{<<"page">> =>
